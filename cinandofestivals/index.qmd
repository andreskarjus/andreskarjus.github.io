...
Film festivals as a network of events, connected if they share overlap in programming, below as a unipartite spring-embedded network diagram. 
...
fig_thematic = ggplot(mapping= aes(V1, V2))+
  ...
  scale_color_manual(values=sixgcols, breaks=ugenre$colorgenre %>% levels )+
