...
```{r examplespace, out.width="95%", fig.height=3, eval=F}
#expl
...
- Approach: train word embeddings on period subcorpora (sliding window), scan for denser-than-expected subspaces - word clusters at a proximity where in 95% cases there would be no more than 1 word
--
...
slides_beedemo
```
.small[Ordinal regression; McFadden's pseudo-R2; kappa = baseline-adjusted classification accuracy, cross-validated mean]
