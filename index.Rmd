...
- A number of workshops in summer 2019 in various venues
- I have been developing materials on data visualization using R; these have been used during 2017-2019 in a number of different workshops for humanities and social science audiences, collectively under the name of [_aRt of the Figure_](https://andreskarjus.github.io/artofthefigure/). All the materials are [open source](https://andreskarjus.github.io/artofthefigure/).
...
- Data visualization with R for corpus linguists, an aRt of the Figure workshop for Corpus Linguistics in Scotland network (12.04.2019)
...
- PPLS Writing Centre short 1h/2h workshops on data visualization using R.
