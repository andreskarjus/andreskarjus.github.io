...
<div style="float: left; width: 60%; height: auto; padding-right:10%; overflow: hidden">

- Will be teaching an aRt of the Figure series workshop for the Corpus Linguistics in Scotland network this Friday (12.04), titled [Data visualization with R for corpus linguists](https://andreskarjus.github.io/artofthefigure) (if you registred but haven't received the email for some reason, please get in touch!).

- The Language Evolves school workshops are [finished for this year](https://twitter.com/kennysmithed/status/1113456451815661568), with Hermitage Park Primary being the last one. Happy to have been part of it.

- "Modelling lexical interactions in diachronic corpora": poster presented at the [Inaugural ISLE workshop](https://www.comparativelinguistics.uzh.ch/en/events/ISLE-inaugural-workshop.html), here is an [online version with interactive plots](https://andreskarjus.github.io/isle_poster) and an extended appendix.
...
<div style="display: inline-block; position: relative;width:100%; height:1px"></div>
...
I am a PhD student in linguistics at the [Centre for Language Evolution at the University of Edinburgh](http://www.lel.ed.ac.uk/cle/), working on lexical dynamics and evolutionary variant selection in language with [Kenny Smith](http://www.lel.ed.ac.uk/~kenny), [Simon Kirby](http://www.lel.ed.ac.uk/~simon) and [Richard A. Blythe](http://www2.ph.ed.ac.uk/~rblythe3/), utilizing massive corpora and natural language processing to hunt traces of selection and competition in language. This research is supported by a Kristjan Jaak scholarship from the Archimedes Foundation of Estonia. I am also affiliated as a (part-time) junior researcher with the University of Tartu [EKKAM](http://ekkam.ut.ee/en/) sociolinguistics group, doing data analysis and agent-based models. I am also engaged in teaching and consulting (see the tab above) stats and data visualization for the humanities and social sciences. On the right is the picture obligatory for all academic home pages to subtly suggest that in fact I do not spend _all_ my time in the office at all.

### Research

#### Publications 

* Andres Karjus, Richard A. Blythe, Simon Kirby, Kenny Smith 2018. Challenges in detecting evolutionary forces in language change using diachronic corpora | [arXiv preprint](http://arxiv.org/abs/1811.01275) | [code](https://github.com/andreskarjus/wfsim_fit) 
...
If you're here about materials for an upcoming workshop: [click here](https://andreskarjus.github.io/artofthefigure/).

<div style="text-align: justify"> 

**Ongoing**

- I have been developing materials on data visualization using R; these have been used during 2017-2019 in a number of different workshops for humanities and social science audiences, collectively under the name of [_aRt of the Figure_](https://andreskarjus.github.io/artofthefigure/). All the materials are [open source](https://github.com/andreskarjus/artofthefigure).
...
- The aRt of the Figure, interactive plots edition, at the CLE PhD retreat 2019
...
- I was working with the PPLS Writing Centre in the summer of 2018 to provide a drop-in quantitative research help service for PPLS MSc students working on their theses.
...
- In 2018-2019 I'm helping my supervisor Prof. Kenny Smith carry out occasional language evolution workshops in primary schools around Edinburgh and Lothian.
...
<br>
<center>
<IMG SRC="round.png" ALIGN="center"; /> 
</center>
