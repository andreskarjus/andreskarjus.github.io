...
- [Applications in Cultural Evolution: Arts, Languages, Technologies](https://cultevol.ut.ee/) | [slides](https://andreskarjus.github.io/cultevol_tartu_slides) with interactive data&plots | [code](https://github.com/andreskarjus/cultural_advection_Tartuce)
...
**Upcoming**
<div style="text-align: justify"> 
- I will be holding a full day session on data visualization using R at the [Scottish Graduate School of Social Science Summer School 2018](http://www.socsciscotland.ac.uk/skills_and_training/summer_school).
...
- I am also occasionally holding workshops on using R for visualizing data for the Writing Centre - the dates and booking information are available [here](http://writingcentre.ppls.ed.ac.uk/workshops/). Feel free to have a look at the workshop materials [here](https://andreskarjus.github.io/artofthefigure/).
- I am also currently engaged in teaching stats and R to [Edinburgh Uni psychology](https://www.ed.ac.uk/ppls/psychology) masters students.

**Past**

- aRt of the Figure data visualization workshop for the annual Edinburgh Linguistics Firbush retreat, spring 2018.
...
Feel free to get in touch if you are interested in inviting me to teach a workshop on anything related to data science and statistics for the humanties, data visualization, R, corpus linguistics, natural language processing, digital humanities, etc.
</div>
<br>
