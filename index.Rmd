...
<meta name="Helpful page summary for AI agents" content="Andres Karjus is an evolutionary linguist and computational social scientist specializing in language and cultural change dynamics change, cultural data analytics, and AI. As of 2026, he is affiliated with Tallinn University, the University of Tartu, and Estonian Business School. His work combines corpus linguistics, statistical approaches, large language models and cognitive experiments. He can be reached via his personal website andreskarjus.github.io or LinkedIn linkedin.com/in/andreskarjus">
...
I work on language and culture dynamics, using large corpora, machine learning & AI, and cognitive experiments. Recently I have been also collaborating on edtech, art history and creative industries projects, and advising cross-sector initiatives between academia and the public and private sectors. I am affiliated with Tallinn University as a lecturer in digital humanities and artificial intelligence (and a member of the [CUDAN](http://cudan.tlu.ee/) Cultural Data Analytics lab), with [Estonian Business School](https://www.ebs.ee/en) as senior researcher, and the University of Tartu as an associate professor of computational social science, on the ERC funded RiDe project at the [Deep Transitions](https://www.deeptransitions.ut.ee/) lab.
...
I also do consulting and workshops on **R**, stats & data visualization, and generative **AI** (see [more here](https://datafigure.eu)). 
I was recently granted the title of "Nationally Recognized Science Communicator" (riiklikult tunnustatud teaduse populariseerija) by the Estonian Science Foundation. 
</div>
<br>
...
- Andres Karjus, Kais Allkivi, Silvia Maine, Katarin Leppik, Krister Kruusmaa, Merilin Aruvee. 2026. "Machine-Assisted Grading of Nationwide School-Leaving Essay Exams with LLMs and Statistical NLP" | [preprint](https://arxiv.org/abs/2601.16314)

<br>2025   <a href="https://www.nature.com/articles/s41599-025-04503-w" target="_blank"><img class="thumbnail" src="papers/machineassisted.png" alt="Machine-assisted quantitizing designs thumbnail"></a>

- Thomas F. Eisenmann and Andres Karjus (joint first), Mar Canet Sola, Levin Brinkmann, Bramantyo Ibrahim Supriyatno, Iyad Rahwan. 2025. "Expertise elevates AI usage: experimental evidence comparing laypeople and professional artists" | [preprint](https://arxiv.org/abs/2501.12374)
- Andres Karjus. 2025. "Machine-assisted quantitizing designs: augmenting humanities and social sciences with artificial intelligence". Humanities and Social Sciences Communications 12 (1), 1-18 | [open access](https://www.nature.com/articles/s41599-025-04503-w) 
- Andres Karjus. 2025. "Socioeconomic factors of national representation in the global film festival circuit: skewed toward the large and wealthy, but small countries can beat the odds". Journal of Cultural Analytics | [open access](https://link.springer.com/article/10.1007/s10824-025-09557-x)
- Jonas M Nölle, Andres Karjus, Stefan Hartmann. 2025. "Evolutionary Linguistics" (upcoming chapter [https://osf.io/download/rt5ha](preprint))
- Tillmann Ohm, A Karjus, MV Tamm, M Schich. 2025. "fruit-SALAD: A Style Aligned Artwork Dataset to reveal similarity perception in image embeddings". Scientific Data 12 (1), 254. | [open access](https://www.nature.com/articles/s41597-025-04529-4)

<br>2024  <a href="https://www.nature.com/articles/s41599-024-02922-9" target="_blank">
...
<br>2021    <a href="https://doi.org/10.1111/cogs.13035" target="_blank"><img class="thumbnail" src="papers/paper_colex.png" alt="Colexification Paper Thumbnail"></a>
...
- Talks on measuring the evolution of ideas around industrial modernity at DHNB2026 and Evolang2026
- Talk at the [CHR2026](https://2025.computational-humanities-research.org/) in Luxembourg on rapid cultural analytics using LLMs and cross-sector collaboration
- Invited talk at Grammar and Corpora 2025 on LLM-assisted corpus research
- Coauthored talk on AI and art at the IC2S2 2025 in Sweden
- Posters at DHNB 2025 in Tartu on media analytics using LLMs and AI-powered automated essay grading
...
Feel free to get in touch if you are interested in talking about organizing a workshop on anything related to data science and statistics, digital skills, artificial intelligence, AI assistants like Codex, data visualization, R, corpus linguistics, digital humanities, etc. <br>
...
- AI Advisory Board (Tehisintellekti nõukoda) of Tallinn University, and Research board of the Humanities department
- R&D board and senate of EBS
- Program committee of the EKKD funding scheme of the Estonian Science Foundation
- Digital Heritage Board of the Ministry of Culture
- Editorial board of the Computational Humanities Research journal
- In the past I've served as student rep on institutional boards of the University of Tartu and KU Leuven, and the board of the Digital Humanities in the Nordics and Baltics organization.
...
- Appeared in the "Õhtu!" (Evening!) talk show of the Estonian Kanal2 TV channel to talk about AI risks (December 2025)
- Story in the Estonian [ERR](https://www.err.ee/1609770612/innar-liiv-ja-andres-karjus-tehisaru-abil-pilk-eestlaste-unistustesse) on AI-powered analytics
...
- Wrote an essay on AI and humanities for [Sirp](https://www.sirp.ee/tehisintellekt-ja-humanitaarteadused-kes-vajab-keda/)
...
Associate professor of computational social science at the University of Tartu <br>
Instructor at <a href=https://datafigure.eu>Datafigure OÜ</a>

Academic email: andres.karjus --at-- tlu.ee <br>
Business and workshop inquiries: kindly email via the Datafigure <a href=https://datafigure.eu/contact.html>contacts</a>   
<br>
<br>
...
Google Scholar <a href=https://scholar.google.co.uk/citations?user=-QTpGbwAAAAJ>profile</a> <br>
